...
const evidenceStories = [
  ...
  },
  {
    ...
    proof: [
      ...
      'Hosted Storybook runway shows Build local gallery, Enable Pages deploy, Verify live Storybook, and Attach hosted proof before hosted-storybook-buyer-evidence can clear.',
  ...
  },
  {
    ...
    proof: [
      ...
      'Hosted Storybook runway keeps storybook:build, STORYBOOK_PAGES_ENABLED=true, storybook-manifest-live, and copyIntoProductionEvidence.hostedStorybook in sequence before hosted proof claims.',
