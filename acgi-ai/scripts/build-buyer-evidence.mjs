...
const evidenceStories = [
  ...
  },
  {
    ...
    proof: [
      ...
      'Hosted Storybook runway shows Build local gallery, Enable Pages deploy, Build proof gap report, Verify live Storybook, and Attach hosted proof before hosted-storybook-buyer-evidence can clear.',
  ...
  },
  {
    ...
    proof: [
      ...
      'Hosted Storybook runway keeps storybook:build, STORYBOOK_PAGES_ENABLED=true, hosted-storybook-proof-gap-report.json, storybook-manifest-live, and copyIntoProductionEvidence.hostedStorybook in sequence before hosted proof claims.',
