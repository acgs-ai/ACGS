...
_UNVERSIONED_CANONICAL_MUTATION_DEFINITIONS: tuple[MutationDefinition, ...] = (
    ...
    MutationDefinition(
        ...
        static_symbols=(
            ...
            "acgs_control_plane.approvals.create_agent_registration_approval_request",
            "acgs_control_plane.managed_mutations._execute_verified_operation",
        ),
    ),
    MutationDefinition(
        ...
        method="POST",
        path="/orgs/{org_id}/approvals/{approval_request_id}/votes",
        action=CONTROL_PLANE_APPROVAL_VOTE_ACTION,
        effect_class=MutationEffectClass.SQL_ATOMIC,
        dispatcher="managed-mutation-uow.execute_with_receipt",
        service="acgs_control_plane.approvals.ApprovalService",
        state_key="approval_service",
        service_method="vote",
        permission=Permission.APPROVAL_VOTE.value,
        scope="org-approval-request-environment",
        static_symbols=(
            "acgs_control_plane.approvals.ApprovalService.vote",
            "acgs_control_plane.managed_mutations._execute_verified_operation",
        ),
    ),
    MutationDefinition(
        ...
        method="POST",
        path="/orgs/{org_id}/approvals/{approval_request_id}/resume",
        action=CONTROL_PLANE_AGENT_CREATE_ACTION,
        effect_class=MutationEffectClass.SQL_ATOMIC,
        dispatcher="managed-mutation-uow.execute_with_receipt",
        service="acgs_control_plane.approvals.ApprovalService",
        state_key="approval_service",
        service_method="resume",
        permission=Permission.APPROVAL_RESUME.value,
        scope="org-approval-request-environment",
        static_symbols=(
            "acgs_control_plane.approvals.ApprovalService.resume",
            "acgs_control_plane.managed_mutations._execute_verified_operation",
        ),
    ),
    MutationDefinition(
        ...
        method="POST",
        path="/orgs/{org_id}/projects/{project_id}/environments/{environment_id}/runtime-enrollment-bootstraps",
        action=CONTROL_PLANE_RUNTIME_BOOTSTRAP_ISSUE_ACTION,
        effect_class=MutationEffectClass.SQL_ATOMIC,
        dispatcher="managed-mutation-uow.execute_with_receipt",
        service="acgs_control_plane.runtime_enrollment.RuntimeEnrollmentService",
        state_key="runtime_enrollment_service",
        service_method="issue_bootstrap",
        permission=Permission.RUNTIME_ENROLLMENT_MANAGE.value,
        scope="org-project-environment",
        static_symbols=(
            "acgs_control_plane.runtime_enrollment.RuntimeEnrollmentService.issue_bootstrap",
            "acgs_control_plane.managed_mutations._execute_verified_operation",
        ),
    ),
    MutationDefinition(
        ...
        service="acgs_control_plane.runtime_enrollment.RuntimeEnrollmentService",
        state_key="runtime_enrollment_service",
        service_method="enroll",
        permission=None,
        scope="bootstrap-token-bound-environment",
        static_symbols=(
            "acgs_control_plane.runtime_enrollment.RuntimeEnrollmentService.enroll",
            "acgs_control_plane.managed_mutations._execute_verified_operation",
        ),
    ),
    MutationDefinition(
        ...
        method="POST",
        path="/v1/runtime-identities/{identity_id}/renew",
        action=CONTROL_PLANE_RUNTIME_IDENTITY_RENEW_ACTION,
        effect_class=MutationEffectClass.SQL_ATOMIC,
        dispatcher="managed-mutation-uow.execute_with_receipt",
        service="acgs_control_plane.runtime_enrollment.RuntimeEnrollmentService",
        state_key="runtime_enrollment_service",
        service_method="renew",
        permission=None,
        scope="runtime-signed-current-credential",
        static_symbols=(
            "acgs_control_plane.runtime_enrollment.RuntimeEnrollmentService.renew",
            "acgs_control_plane.managed_mutations._execute_verified_operation",
        ),
    ),
    MutationDefinition(
        ...
        method="POST",
        path="/orgs/{org_id}/projects/{project_id}/environments/{environment_id}/runtime-identities/{identity_id}/revoke",
        ...
        permission=Permission.RUNTIME_IDENTITY_REVOKE.value,
        scope="org-project-environment",
        static_symbols=(
            "acgs_control_plane.runtime_enrollment.RuntimeEnrollmentService.revoke",
            "acgs_control_plane.managed_mutations._execute_verified_operation",
        ),
    ),
    MutationDefinition(
