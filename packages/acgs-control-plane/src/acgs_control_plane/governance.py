...
ROUTE_CONTRACTS: tuple[RouteContract, ...] = (
    ...
    RouteContract(
        "POST",
        "/v1/orgs/{org_id}/approvals/{approval_request_id}/votes",
        ExecutionClass.CANONICAL_MANAGED_WRITE,
        CONTROL_PLANE_APPROVAL_VOTE_ACTION,
        True,
        False,
    ...
    RouteContract(
        "POST",
        "/v1/orgs/{org_id}/approvals/{approval_request_id}/resume",
        ExecutionClass.CANONICAL_MANAGED_WRITE,
        CONTROL_PLANE_AGENT_CREATE_ACTION,
        True,
        False,
    ...
    RouteContract(
        "POST",
        "/v1/orgs/{org_id}/projects/{project_id}/environments/{environment_id}/runtime-enrollment-bootstraps",
        ExecutionClass.CANONICAL_MANAGED_WRITE,
        CONTROL_PLANE_RUNTIME_BOOTSTRAP_ISSUE_ACTION,
        True,
        False,
    ...
    RouteContract(
        "POST",
        "/v1/orgs/{org_id}/projects/{project_id}/environments/{environment_id}/runtime-identities/{identity_id}/revoke",
        ExecutionClass.CANONICAL_MANAGED_WRITE,
        CONTROL_PLANE_RUNTIME_IDENTITY_REVOKE_ACTION,
        True,
        False,
