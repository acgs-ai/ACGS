...
**[Event](src/agent_bus_analyzer/models.py:54-74)** — A single captured observation.
...
**[Trace](src/agent_bus_analyzer/models.py:77-87)** — One governance-relevant run.
...
Defined in [`hashing.py`](src/agent_bus_analyzer/hashing.py:26-33).
