...
| Audit chain integrity | PASS (1 event(s), hash-linked) |
...
| Signature | signed (ed25519, key `fixture-key-1`) — verification requires the relying party's own copy of the public key (`--verifier-key`), never a key shipped inside this pack |

## The governed action

- **Action**: `runtime.file.write`
- **Declared goal**: write compliance report
...
- **Receipt**: `ev_7d241528aa27483e` (request `req-allow`)
