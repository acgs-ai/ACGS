...
result. It packages the :class:`~acgs_proofpack_verifier.decision.DecisionRecord`, the
audit chain hash, the actor identity, and a digest of the result. Receipts
are the unit of replay (see :mod:`acgs_proofpack_verifier.replay`).
"""
...
from acgs_proofpack_verifier.signing import ReceiptSigner
...
class DecisionReceipt:
    ...
    (:func:`acgs_proofpack_verifier.executor.execute_with_receipt`,
    :class:`acgs_proofpack_verifier.executor.GovernedExecutor`,
    :class:`acgs_proofpack_verifier.contracts.ReceiptVerifier`) now *require* ``expected_actor``,
    ...
    **Precondition for closure.** The residual is closed only when receipts are
    ...
    def from_record(
        ...
        *,
        ...
        """
        from acgs_proofpack_verifier.errors import ReceiptRejectionReason, ReceiptValidationError
    ...
    def verify(
        ...
        *,
        ...
        lives at the gate surfaces — :func:`acgs_proofpack_verifier.executor.execute_with_receipt`,
        :class:`acgs_proofpack_verifier.executor.GovernedExecutor`, and
        :class:`acgs_proofpack_verifier.contracts.ReceiptVerifier`. Authorize side effects through
        ...
        (:meth:`acgs_proofpack_verifier.profile.GovernanceProfile.production_strict`) sets this
        ...
        :class:`acgs_proofpack_verifier.revocation.RevocationList` of compromised *signing*
        ...
        *before* the signature is trusted — independent of whether the key is
        ...
        behavior exactly.
        """
        from acgs_proofpack_verifier.decision import Decision
        from acgs_proofpack_verifier.errors import ReceiptRejectionReason, ReceiptValidationError
        ...
        if self.decision == Decision.ALLOW.value and expected_args is not None:
            from acgs_proofpack_verifier.decision import sha256_json as _sha256_json
