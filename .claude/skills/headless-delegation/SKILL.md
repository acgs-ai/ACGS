...
description: Use when delegating work to a headless (non-interactive) `claude -p` lane — brief authoring standard, tool allowlists, turn caps, adversarial review stage, streaming-abort recovery, and parent re-verification.
---
