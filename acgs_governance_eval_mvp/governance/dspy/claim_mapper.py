...
class EvidenceToClaimMapper:
    ...
    def map_claim(
        ...
        *,
        ...
        combined_missing = _dedupe([*missing_evidence, *list(output_data.get("missing_evidence", []))])
        ...
        entry_before_append = ClaimLedgerEntry(
            ...
            claim_text=claim_text,
            verdict=verdict,
            evidence_refs=list(output_data.get("evidence_refs", evidence_refs)),
            missing_evidence=combined_missing,
    ...
    def _decide_verdict(
        ...
        *,
        ...
        if engine_verdict not in KNOWN_VERDICTS:
            return "undecidable"
        if self._integrity_failed(audit_event_ids) and engine_verdict == "supported":
            return "invalidated"
