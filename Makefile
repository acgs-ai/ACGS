...
test-py:
	...
	(cd packages/mutation-authority && $(UV) run python -m pytest tests integration_tests EXTERNAL_SUBSTRATE_IDENTITY_AND_AUTHORITY_INGESTION_V1/attack_suite --import-mode=importlib) || exit $$?
