...
| Signing mode | `packages/gove-zone/src/gove_zone/signing.py` | Optional Ed25519 signing for receipts. Default is unsigned local mode; production-like closure requires signer + verifier + `require_signature=True`. |
