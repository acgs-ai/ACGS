...
| Item | Repo | Problem |
|---|---|---|
| Stale gove-zone publish claim | acgs-lite | Published README still says gove-zone "not yet published to PyPI" (PyPI has 1.0.0rc2 since 2026-08-23) |
| Dead docs links | acgs-lite | Badges and docs table link to https://acgs.ai/docs/* (404) |
| Commercial licenses footer | acgs-lite | Links commercial licenses to acgs.ai (no commercial page on origin) |
| Broken website sentence | gove-zone | README: "The project website is." (truncated) |
| Private-repo wording | gove-zone | README: "while this repository remains private" (repo is public) |
