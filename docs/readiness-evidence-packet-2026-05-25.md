...
| `make platform-readiness` | Pass with pending external item | `30/31 pass`, `0 fail`, `1 pending`; pending item is `hosted-storybook-buyer-evidence` |
| `make release-evidence` | Pass with pending external item | Bundle written to `dist-release-evidence`; `30/31 pass`, `0 fail`, `1 pending` |
| `make production-launch-preflight` | Blocked as expected | Current clean commit; readiness `30/31 pass`, `0 fail`, `1 pending`; live verifier still fail; external proof blockers remain |
