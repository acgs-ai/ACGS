...
| `beta/p0-g030b-pr308-rebased-repair` | NO-OP | 2026-07-15 |
| `beta/p0-g102e0-audit-appender` | NO-OP | 2026-07-26 |
| `beta/p0-g102e1-db-governance-event` | NO-OP | 2026-07-26 |
| `beta/p0-g102e2-native-receipt-ledger` | NO-OP | 2026-07-26 |
| `beta/p0-g102e3-verifiable-native-evidence` | NO-OP | 2026-07-26 |
| `beta/p0-g102e4-scope-attachment` | NO-OP | 2026-07-26 |
| `beta/p0-g102e5-native-transaction-spine` | NO-OP | 2026-07-26 |
| `beta/p1-evidence-corpus-001d` | NO-OP | 2026-07-25 |
| `beta/p1-evidence-corpus-002d` | NO-OP | 2026-07-25 |
| `beta/p1-evidence-corpus-003d` | NO-OP | 2026-07-25 |
| `beta/p1-evidence-corpus-004d` | NO-OP | 2026-07-25 |
| `beta/p1-g101-integrated-candidate` | NO-OP | 2026-07-18 |
| `beta/p1-g101-program-reconcile` | NO-OP | 2026-07-25 |
| `beta/p1-g101-tool-provenance` | NO-OP | 2026-07-25 |
| `beta/p1-g102-request-admission` | NO-OP | 2026-07-25 |
| `beta/p1-g102a-program-reconcile` | NO-OP | 2026-07-25 |
| `beta/p1-g102b-program-reconcile` | NO-OP | 2026-07-26 |
| `beta/p1-g102b-receipt-cursors` | NO-OP | 2026-07-26 |
| `beta/p1-g102c-openapi-drift` | NO-OP | 2026-07-26 |
| `beta/p1-g102c-program-reconcile` | NO-OP | 2026-07-26 |
| `beta/p1-g102d-program-reconcile` | NO-OP | 2026-07-26 |
| `beta/p1-g102d-v1-api-contract` | NO-OP | 2026-07-26 |
| `beta/p1-ledger-003` | NO-OP | 2026-07-25 |
| `beta/p1-migration-001` | NO-OP | 2026-07-25 |
| `beta/p1-scope-002` | NO-OP | 2026-07-25 |
| `beta/p1-trust-004` | NO-OP | 2026-07-25 |
| `beta/p1-trust-004-gz` | NO-OP | 2026-07-25 |
| `beta/p2-evidence-corpus-000d` | NO-OP | 2026-07-25 |
| `beta/p2-evidence-corpus-001d` | NO-OP | 2026-07-25 |
| `beta/p2-idempotency-evidence-002a` | NO-OP | 2026-07-26 |
| `beta/p2-register-001-retry` | NO-OP | 2026-07-26 |
...
| `chore/monorepo-hardening` | NO-OP | 2026-06-07 |
| `chore/ruff-format-a2a-demo` | LANDED | 2026-07-02 |
| `chore/ruff-format-test-audit-chain-2026-05-13` | NO-OP | 2026-05-16 |
| `ci/harden-package-runners` | NO-OP | 2026-06-06 |
| `claude/acgs-prior-art-verification-vvn6ni` | NO-OP | 2026-07-18 |
| `codex/clarify-gove-zone-prompt-examples` | NO-OP | 2026-06-06 |
| `dislovelhl-patch-1` | LANDED | 2026-08-11 |
...
| `docs/comparison-agt-permit` | NO-OP | 2026-08-09 |
| `docs/comparison-microsoft` | NO-OP | 2026-06-07 |
| `docs/console-forward-auth-design` | NO-OP | 2026-06-06 |
| `docs/deploy-dns-records` | NO-OP | 2026-06-25 |
| `docs/deploy-vercel-residue` | NO-OP | 2026-06-25 |
| `docs/design-and-solutions-notes` | NO-OP | 2026-06-06 |
| `docs/gove-zone-readme-honesty` | NO-OP | 2026-06-07 |
| `docs/governance-failure-modes` | NO-OP | 2026-05-06 |
| `docs/openswarm-comparison-and-ci-handoffs-2026-05-13` | NO-OP | 2026-05-16 |
| `docs/skill-forge-runbooks` | NO-OP | 2026-06-07 |
| `docs/solutions-ci-gate-parity` | NO-OP | 2026-06-06 |
| `docs/submodule-token-runbook-v1` | NO-OP | 2026-05-16 |
| `ecc-tools/govern-zone-1779994771092` | NO-OP | 2026-05-28 |
| `feat/acgs-conductor-adapter-spike` | LANDED | 2026-05-26 |
| `feat/acgs-design-system` | NO-OP | 2026-06-07 |
| `feat/acgs-phoenix-observability-clean` | NO-OP | 2026-05-07 |
| `feat/add-research-packages` | NO-OP | 2026-06-06 |
| `feat/agent-bus-analyzer-frontend-tests` | NO-OP | 2026-05-28 |
| `feat/copilot-eval-spike` | NO-OP | 2026-06-07 |
| `feat/copilot-governance-bridge` | NO-OP | 2026-06-07 |
| `feat/enterprise-control-plane` | LANDED | 2026-07-17 |
| `feat/external-submodule-openswarm-2026-05-13` | NO-OP | 2026-05-16 |
| `feat/external-submodules-2026-05-13` | NO-OP | 2026-05-13 |
| `feat/extract-control-plane` | LANDED | 2026-08-06 |
| `feat/gove-zone-audit-cheap-fixes` | NO-OP | 2026-07-11 |
| `feat/gove-zone-b20-audit-sink` | LANDED | 2026-06-24 |
| `feat/gove-zone-b3rem-closeout` | LANDED | 2026-06-23 |
| `feat/gove-zone-conformance-plane` | NO-OP | 2026-05-28 |
| `feat/gove-zone-full-digest-policy-identity` | NO-OP | 2026-07-28 |
| `feat/gove-zone-governance-dag` | NO-OP | 2026-07-11 |
| `feat/gove-zone-maci-role-separation` | NO-OP | 2026-05-30 |
| `feat/gove-zone-plan-level-governance` | NO-OP | 2026-05-30 |
| `feat/gove-zone-policy-identity` | NO-OP | 2026-07-27 |
| `feat/gove-zone-production-profile-evidence` | NO-OP | 2026-06-06 |
| `feat/gove-zone-replay-side-store` | NO-OP | 2026-06-06 |
| `feat/gove-zone-w0-m0-evidence-capture-20260726` | NO-OP | 2026-07-26 |
| `feat/gove-zone-w0-m0-runtime-capture-20260726` | NO-OP | 2026-07-30 |
| `feat/gove-zone-workflow-receipt-chain` | NO-OP | 2026-05-31 |
| `feat/hub-receipt-gate-hero` | NO-OP | 2026-06-06 |
| `feat/iii-governance-lab-static-ci` | NO-OP | 2026-05-27 |
| `feat/marketing-dark-register` | LANDED | 2026-07-26 |
| `feat/mcp-gateway-design` | LANDED | 2026-07-03 |
| `feat/mutation-authority-validator-trust` | LANDED | 2026-08-11 |
| `feat/phase-3-audit` | NO-OP | 2026-05-16 |
| `feat/pre-launch-hardening` | NO-OP | 2026-07-22 |
| `feat/self-fitting-executor-workflow` | LANDED | 2026-07-06 |
| `feat/submodule-token-runbook-v0` | NO-OP | 2026-05-16 |
| `feature/governance-trajectory-pipeline` | LANDED | 2026-08-07 |
| `final-goal/g2-3` | LANDED | 2026-07-10 |
| `final-goal/g3-4` | LANDED | 2026-07-10 |
| `fix/acgs-ai-vercel-filesystem-route` | NO-OP | 2026-06-07 |
| `fix/agents-skill-frontmatter` | NO-OP | 2026-08-06 |
| `fix/ci-latency-test-and-swarm-submodule` | NO-OP | 2026-05-16 |
| `fix/ci-tests-docs-and-iii-lab-static` | NO-OP | 2026-07-25 |
| `fix/ci-two-step-submodule-checkout-2026-05-13` | NO-OP | 2026-05-13 |
| `fix/codex-review-blacksmith-sudo` | NO-OP | 2026-08-03 |
| `fix/codex-review-false-green` | NO-OP | 2026-07-30 |
| `fix/console-fake-auth-and-mock-safety` | NO-OP | 2026-05-12 |
| `fix/constitutional-hash-lock-clinicalguard` | NO-OP | 2026-05-16 |
| `fix/drop-caller-worker-otel-advisories` | NO-OP | 2026-07-30 |
| `fix/evidence-pack-lf-extraction` | NO-OP | 2026-07-18 |
| `fix/example-demos-dev-profile` | NO-OP | 2026-06-07 |
| `fix/gove-zone-demo-duplicate-kwarg` | LANDED | 2026-06-09 |
| `fix/gove-zone-pql-fail-closed-20260726` | LANDED | 2026-07-26 |
| `fix/governance-critical-c1-c2-c3` | NO-OP | 2026-05-07 |
| `fix/keep-github-hosted-security-lanes` | NO-OP | 2026-07-25 |
| `fix/lint-baseline-parent-2026-05-13` | NO-OP | 2026-05-16 |
| `fix/pages-jekyll-scope` | NO-OP | 2026-07-28 |
| `fix/postgres-gate-head-0007-assertions` | NO-OP | 2026-07-26 |
| `fix/uv-workspace-gove-zone-source` | NO-OP | 2026-07-23 |
| `fix/worker-routes-in-config` | LANDED | 2026-07-11 |
| `fix/workflows-drop-truthy-fallback` | NO-OP | 2026-05-16 |
| `land/dependabot-npm` | LANDED | 2026-07-26 |
| `land/pql-400` | NO-OP | 2026-07-26 |
| `launch/stage3-landing-thesis` | NO-OP | 2026-06-06 |
| `olla-pinyon` | NO-OP | 2026-05-06 |
