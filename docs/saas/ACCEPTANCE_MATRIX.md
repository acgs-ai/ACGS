...
| AM-005 | Tenant-scoped managed control-plane foundation | partial | current_local | G101, G102, G103, G104, G105, G106 | PR #324 remains the open-draft G101 anchor. Independently reviewed, current-local, open-draft, unmerged increments #329-#332 add a statically validated PostgreSQL CI definition, a disposable recovery drill, local independent-process coordination/SIGKILL rollback evidence, and a fail-closed migration operator CLI. They are not CI-backed: #329-#331 recorded zero-job `BuildFailed` startup failures, while #332 Codex Code Review run 29393469672 started zero steps with `The job was not started because your account is locked due to a billing issue.` This does not establish #308 startup integration, accepted/merged G101 evidence, production backup/PITR or multi-host/failover/rolling-upgrade operations, G103-owned tenant context, composite constraints, RLS, tenant schema/search-path, role hardening, or API/policy/backfill adoption; this is not completed Phase-1 acceptance. Do not start G102. |
