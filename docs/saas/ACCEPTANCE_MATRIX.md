...
| AM-005 | Tenant-scoped managed control-plane foundation | partial | current_local | G101, G102, G103, G104, G105, G106 | PR #324 remains the open-draft G101 anchor. PR #330 exact head `31badd9` is independently approved and current-local only: five repairs provide atomic private `.pgpass` handling and exact mode enforcement, portable directory fsync, fixed retained canonical fingerprint limits, aggregate-only PostgreSQL logical-row preflight with batch-one streaming, manifest-v1 digest compatibility, and read-only `REPEATABLE READ` before/after captures. Local evidence includes 48 targeted and 116 package tests passing with 2 credential-gated PostgreSQL skips, plus wrapper-free disposable PostgreSQL 17 proof of empty-to-`version_0002` upgrade, real read-only repeatable-read capture, seeded-data capture, oversized JSONB refusal before raw receipts streaming, and a separate 4-of-4 PostgreSQL migration suite. The 4 pg_dump/pg_restore recovery tests remain harness-blocked and live bytea preflight remains unverified. CI run `29414888896`, job `87350442086`, failed before steps because of billing, so `ci_backed` remains false and the PR remains unmerged. PRs #329, #331, and #332 retain separate current-local review records. This does not prove production backup/PITR, a total-process memory bound, multi-host/failover operations, #308 startup integration, or completed Phase-1 acceptance. Do not start G102. |
