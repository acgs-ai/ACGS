...
| AM-005 | Tenant-scoped managed control-plane foundation | partial | current_local | G101, G102, G103, G104, G105, G106 | Independently reviewed, local SQLite G101 migration-core evidence covers Alembic 0001/0002, project/environment schema constraints, guarded preflight/resume, legacy create_all containment, and a wheel-resource execution proof. It does not establish #308 startup integration, PostgreSQL/RLS/advisory-lock/multi-instance safety, backup/restore or a forward-only rollback runbook, or API/policy/backfill adoption; this is not completed Phase-1 acceptance. |
