...
| Platform UI/UX | Local product blueprint | `docs/platform-ui-ux-research.md`, `acgi-ai/DESIGN.md`, and the same-style marketing workbench map the easy-use operator flow: work queue → trace graph → evaluation panel → human release gate → evidence room | `docs/platform-ui-ux-research.md`; `acgi-ai/DESIGN.md`; `acgi-ai/src/routes/Marketing.tsx`; `pnpm -F acgi-ai run test:platform-blueprint` | Medium-high for local blueprint wiring | Rendered-browser UX quality, production console implementation, live buyer evidence, certification, or assurance claims | Browser/screenshot QA, console implementation evidence, hosted Storybook proof, legal/assurance review |
